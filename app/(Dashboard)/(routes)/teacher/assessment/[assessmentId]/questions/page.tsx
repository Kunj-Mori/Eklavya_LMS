...
export default function QuestionsPage({ params }: PageProps) {
  ...
  const createNewQuestion = (type: string) => {
    router.push(`/teacher/assessment/${params.assessmentId}/questions/new?type=${type}`);
  };
  ...
  return (
    <div className="p-6">
      <div className="flex items-center mb-6">
        <Button 
          onClick={() => router.push(`/teacher/assessment/${params.assessmentId}`)} 
          variant="ghost" 
          className="mr-2"
        >
            ...
            {filteredQuestions.length === 0 ? (
              ...
              filteredQuestions.map((question) => (
                <QuestionCard
                  ...
                  onEdit={() => router.push(`/teacher/assessment/${params.assessmentId}/questions/${question.id}`)}
                />
              ))
            )}
          </div>
