...
export default function AssessmentDetailsPage({ params }: PageProps) {
  ...
  useEffect(() => {
    const fetchAssessment = async () => {
      try {
        ...
        setResultsPublished(response.data.resultsPublished || false);
      } catch (error) {
  ...
  const handlePublishResults = async () => {
    try {
      await axios.patch(`/api/assessments/${params.assessmentId}/publish-results`, {
  ...
  const handleExportResults = async () => {
    try {
      const response = await axios.get(`/api/assessments/${params.assessmentId}/export-results`, {
        responseType: 'blob'
      });
  ...
  if (!assessment) {
    return (
      <div className="p-6">
        ...
        <Button onClick={() => router.push("/teacher/assessment")} variant="outline" className="mt-4">
          Back to Assessments
        </Button>
      </div>
    );
    ...
    <div className="p-6">
      <div className="flex items-center mb-6">
        ...
        <div className="ml-auto flex gap-2">
          <Button 
            variant="outline" 
            onClick={() => router.push(`/teacher/assessment/${assessment.id}/edit`)}
          >
            ...
            <Card>
              ...
              <CardContent className="pt-0">
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => router.push(`/teacher/assessment/${assessment.id}/questions`)}
                >
            ...
            <Card>
              ...
              <CardContent className="pt-0">
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => router.push(`/teacher/assessment/${assessment.id}/candidates`)}
                >
            ...
            <Card>
              ...
              <CardContent className="pt-0">
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => router.push(`/teacher/examination/${assessment.id}/preview`)}
                >
        ...
        <TabsContent value="questions">
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <Button onClick={() => router.push(`/teacher/assessment/${assessment.id}/questions`)}>
                Manage Questions
              </Button>
            </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 border rounded-md bg-gray-50">
                    ...
                    <div className="mt-4">
                      <Button
                        onClick={() => window.open(`/teacher/examination/${assessment.id}`, '_blank')}
                      >
                        <Play className="h-4 w-4 mr-2" />
                        Open Full Preview
                      </Button>
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-2">
              <Button 
                ...
                disabled={isLoadingResponses || responses.length === 0}
              >
                            ...
                            <TableRow key={response.id}>
                              ...
                              <TableCell className="text-right">
                                <Button 
                                  variant="outline" 
                                  size="sm"
                                  onClick={() => router.push(`/teacher/assessment/${params.assessmentId}/responses/${response.id}`)}
                                >
                                  View Details
                                </Button>
                              </TableCell>
